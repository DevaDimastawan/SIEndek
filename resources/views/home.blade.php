...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src={{ asset('images/endek-carousel.png') }} class="d-block w-100" alt="Endek Carousel" style="filter: brightness(35%)">
  ...
  <div class="row">
    <div class="pl-5 col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column">
      <div class="container">
          ...
          <p class="text-justify pt"data-aos="fade-up" data-aos-delay="400 py-3">Endek adalah salah satu hasil kerajinan tenun yang memiliki ragam hias yang beragam dan dikerjakan dengan menggunakan teknik ikat tunggal atau single ikat. Kain endek mulai berkembang sejak abad ke-16, yaitu masa pemerintahan Raja Dalem Waturenggong di Gelgel, Klungkung. Kain endek ini kemudian berkembang di sekitar daerah Klungkung, salah satunya adalah di Desa Sulang. Di desa Sulang, kain tenun endek dipelopori oleh Wayan Rudja yang saat itu memiliki tenaga kerja sekitar 200 karyawan.</p>
          <p class="text-justify"data-aos="fade-up" data-aos-delay="400 py-3">Meskipun kain endek telah ada sejak Kerajaan Gelgel, tetapi endek baru mulai berkembang pesat di desa Sulang setelah masa kemerdekaan. Perkembangan kain endek di Desa Sulang dimulai pada tahun 1975 dan kemudian berkembang pesat pada tahun 1985 hingga sekarang. Kain endek memiliki ciri khas lewat corak, motif, warna yang digunakan. Setiap simbol dalam kain endek sarat akan makna tersendiri. Kain ini memiliki beberapa motif yang  Jenis motif pada kain endek yaitu Dekoratif,Fauna,Figuratif,Flora,Geometris</p>
