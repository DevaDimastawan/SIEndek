                ...
                <form action="" method="GET" id="cari_kriteria ">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="dropdown">
                                <select class="btn dropdown-toggle mt-2" name="cari_motif" id="cari_motif"
                        ...
                        <div class="col">
                            ...
                            <div class="dropdown">
                                <select class="btn dropdown-toggle mt-2" name="cari_bahan" id="cari_bahan"
                                    style=" background-color: white">
                                    <option value="">Pilihlah salah satu</option>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="dropdown">
                                <select class="btn dropdown-toggle mt-2" name="cari_sisir" id="cari_sisir"
                                    style=" background-color: white">
                                    <option value="">Pilihlah salah satu</option>
                        ...
                        <div class="col">
                            ...
                            <div class="dropdown">
                                <select class="btn dropdown-toggle mt-2" name="cari_as" id="cari_as"
                                    style=" background-color: white">
                                    <option value="">Pilihlah salah satu</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="dropdown">
                                <select class="btn dropdown-toggle mt-2" name="cari_ukurankain" id="cari_ukurankain"
                                    style=" background-color: white">
                                    <option value="">Pilihlah salah satu</option>
                        ...
                        <div class="col">
                            ...
                            <div class="dropdown">
                                <select class="btn dropdown-toggle mt-2" name="cari_warna" id="cari_warna"
                                    style=" background-color: white">
                                    <option value="">Pilihlah salah satu</option>
